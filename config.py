...
loc_region = "England"                 		  # Enter either your state or country
weather_location = "Bradford"			 	  # This could pretty much everything: city, state, country, ...
news_count = 7                        		  # How many news stories Vector should read (max is 7 to 9)
...
voice_volume = 5                      		  # Vector's voice volume between "1" and "5". (5 is very loud)
