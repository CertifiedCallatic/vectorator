...
weather_location = ""			 	  # This could pretty much everything: city, state, country, ...
...
mail_account = "XXXXX@gmail.com"   		  # the email address that is checked
mail_pw = ""       				  # the mail password
